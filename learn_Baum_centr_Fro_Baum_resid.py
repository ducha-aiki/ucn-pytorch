...
class BaumResNet(nn.Module):
    ...
    def __init__(self, PS = 16):
        ...
        self.Baum = AffineShapeEstimator(patch_size = 16)
        self.PS = PS
...
HA = ScaleSpaceAffinePatchExtractor( mrSize = 3.0, num_features = 350, border = 5, num_Baum_iters = 1, AffNet = BaumResNet())
