...
from SparseImgRepresenterLAFAdd import ScaleSpaceAffinePatchExtractor
...
def train(train_loader, model, optimizer, epoch, cuda = True):
    ...
    torch.save({'epoch': epoch + 1, 'state_dict': model.state_dict()},
               '{}/new_loss_add_checkpoint_{}.pth'.format(LOG_DIR, epoch))
