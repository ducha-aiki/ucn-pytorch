...
from Utils import L2Norm,GaussianBlur, batch_eig2x2, line_prepender
...
class HessianAffinePatchExtractor(nn.Module):
    ...
    def forward(self,x):
        ...
        patches_small = self.extract_patches(scale_pyr, final_aff_m, final_pyr_idxs,final_level_idxs, PS = 16, gauss_mask = False, pyr_inv_idxs = pyr_inv_idxs);
        ###
